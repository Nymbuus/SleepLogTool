...
class TestWriteToCsv(unittest.TestCase):
    ...
    def test_write_to_csv_correct_values(self):
        ...
        actual_file_path = self._fp.write_to_csv(actual_file_path, ["SleepLogTool\\blf_testfiles\\Trace_BP11_Display_1_20240221_133700_20240221_133859_#08-1_LEM.blf"])
    ...
    def test_write_to_csv_txt_in_file_name(self):
        ...
        with self.assertRaises(TypeError):
            self._fp.write_to_csv(file_path, ["SleepLogTool\\blf_testfiles\\Trace_BP11_Display_1_20240221_133700_20240221_133859_#08-1_LEM.blf"])
        os.remove(file_path)
    ...
    def test_write_to_csv_txt_in_file_list(self):
        ...
        f.close()
        with self.assertRaises(TypeError):
            self._fp.write_to_csv("SleepLogTool\\test_folder\\csv_test_files\\expected_write_to_csv_test_file.csv", file_path)
        os.remove(file_path)
